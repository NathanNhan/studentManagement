...
<form class="row g-3 mt-5" action="${pageContext.request.contextPath }/AddStudent" method="post">
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="sgrade" name="sgrade" placeholder="CGBA">
  </div>
  <div class="col-12">
